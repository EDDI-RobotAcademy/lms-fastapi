...
async def save_log(
    ...
    chatlog_service.save_log(account_id, recipe, recipe_hash)
...
async def get_log(
    ...
    log_data = chatlog_service.get_log(account_id, recipe_hash)
    if log_data is None:
...
async def delete_log(
    ...
    chatlog_service.delete_log(account_id, recipe_hash)
